...
<?php $__env->startSection('title', 'Onsite Payment Verification'); ?>
...
$(document).ready(function() {
    ...
    function loadPendingPayments() {
        $.ajax({
            url: '<?php echo e(route("admin.onsite-payments.pending")); ?>',
            method: 'GET',
    ...
    $('#confirmPaymentBtn').click(function() {
        ...
        $.ajax({
            url: `<?php echo e(url('/admin/onsite-payments')); ?>/${currentEnrollmentId}/confirm`,
            method: 'POST',
            data: {
                notes: notes,
    ...
    $('#rejectPaymentBtn').click(function() {
        ...
        $.ajax({
            url: `<?php echo e(url('/admin/onsite-payments')); ?>/${currentEnrollmentId}/reject`,
            method: 'POST',
            data: {
                reason: reason,
                _token: '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views\Admin\onsite_payments.blade.php ENDPATH**/ ?>