...
<body class="bg-gray-100 font-sans">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="sidebar bg-blue-900 text-white w-56 flex flex-col">
            ...
            <?php echo $__env->make('Student.partials.navigation', ['cache_bust' => time()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <!-- Student-specific Loading Configuration -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
        ...
        function initStudentLoading() {
            // Add loading to student navigation
        ...
        // Student dropdown toggle
        document.getElementById('studentDropdown').addEventListener('click', function(e) {
            e.stopPropagation();
            document.getElementById('dropdownMenu').classList.toggle('hidden');
        });
