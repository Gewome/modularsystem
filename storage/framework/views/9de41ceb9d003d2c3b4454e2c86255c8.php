                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200" id="issuedTable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr data-name="<?php echo e($certificate->user->name); ?>" data-id="<?php echo e($certificate->user->student_id); ?>" data-program="<?php echo e($certificate->program->name ?? 'No Program'); ?>" data-issued-date="<?php echo e($certificate->issued_date ?? now()->format('Y-m-d')); ?>">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($certificate->user->name); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($certificate->program->name ?? 'No Program'); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($certificate->issued_date ? \Carbon\Carbon::parse($certificate->issued_date)->format('M d, Y') : now()->format('M d, Y')); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button class="text-blue-600 hover:text-blue-900 mr-3 preview-btn"
                                            data-name="<?php echo e($certificate->user->name); ?>"
                                            data-program="<?php echo e($certificate->program->name ?? 'No Program'); ?>"
                                            data-date="<?php echo e($certificate->completion_date); ?>">
                                            Preview
                                        </button>
                        ...
                        <div class="mt-4">
                            <?php echo e(($issuedCertificates ?? collect())->links()); ?>
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views\Admin\issued_certificates.blade.php ENDPATH**/ ?>